...
class WelfareConverter:
    ...
    def insert_unified(self, service):
        ...
        for benefit in benefits:
            ...
            or_parent_disability_level = self.to_json(or_cond.get('requires_parent_disability_level'))
            ...
            INSERT INTO danz_welfare_services (
              ...
              fd_or_income_max_percent, fd_or_household_members_min, fd_or_household_members_max,
              ...
              fd_or_age_min_months, fd_or_age_max_months, fd_or_requires_parent_disability_level
            ) VALUES (
              %s, %s, %s, %s, %s, %s, %s, %s, %s,
              %s, %s, %s, %s, %s, %s, %s, %s,
              %s, %s, %s, %s, %s, %s, %s, %s, %s,
            ...
            try:
                self.cursor.execute(sql, (
                    ...
                    or_req_disability, or_req_parent_disability, or_disability_level,
                    ...
                    or_income_max_percent, or_household_members_min, or_household_members_max,
                    ...
                    or_age_min_months, or_age_max_months, or_parent_disability_level
                ))
