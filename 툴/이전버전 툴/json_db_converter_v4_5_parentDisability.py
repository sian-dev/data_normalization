...
class WelfareDBConverterV4_2:
    ...
    def insert_benefit(self, service_id, benefit):
        ...
        INSERT INTO welfare_benefits (
          ...
          requires_disability, requires_parent_disability, child_disability_level, parent_disability_level,
        ...
        try:
            self.cursor.execute(sql, (
                ...
                and_cond.get('birth_order_min'),
                and_cond.get('birth_order_max'),
                ...
                and_cond.get('child_disability_level'),
